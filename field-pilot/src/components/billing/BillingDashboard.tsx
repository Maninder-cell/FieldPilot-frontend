...
export function BillingDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Usage Metrics - Only show if there's an active subscription that's not canceled */}
      {billingOverview?.subscription && 
       !billingOverview.subscription.cancel_at_period_end && 
      ...
      <div className="bg-gray-50 rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Show different actions based on subscription status */}
          {billingOverview?.subscription && !billingOverview.subscription.cancel_at_period_end ? (
            <>
              <Link
                href="/billing/plans"
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900">Buy a Plan</span>
            </Link>
          )}
