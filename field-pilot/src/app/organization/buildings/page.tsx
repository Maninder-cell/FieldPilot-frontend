...
export default function BuildingsPage() {
  ...
  const loadBuildings = async (page: number = currentPage, size: number = pageSize) => {
    try {
      setIsLoading(true);
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0 flex-1">
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 truncate">Buildings</h1>
              <p className="mt-1 text-xs sm:text-sm text-gray-600">
                Manage buildings across all facilities
              </p>
            </div>
            {/* Add Building Button - Desktop Only */}
            <button
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {/* Add Building Button - Mobile/Tablet */}
              <button
                onClick={handleCreate}
                ...
                {buildings.map((building) => (
                  <div key={building.id} className="p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-start justify-between mb-3">
                      <div className="min-w-0 flex-1">
                        <h3 className="text-sm font-semibold text-gray-900 truncate">{building.name}</h3>
                    ...
                    <div className="space-y-2 mb-3">
                      <div className="flex items-center text-xs text-gray-600">
                        <span className="font-medium w-20">Facility:</span>
                        <span>{building.facility_name || '-'}</span>
                      </div>
                      <div className="flex items-center text-xs text-gray-600">
                      ...
                      <div className="flex items-center gap-1 text-xs text-gray-600">
                        ...
                        <span>{building.equipment_count} Equipment</span>
                      </div>
                    </div>
