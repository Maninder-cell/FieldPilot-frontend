            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  disabled={isSubmitting}
                  className="w-full px-4 py-2.5 pr-10 text-gray-900 bg-white border border-gray-300 rounded-lg appearance-none transition-colors focus:outline-none focus:ring-2 focus:ring-offset-0 focus:border-emerald-500 focus:ring-emerald-500 disabled:bg-gray-100 disabled:cursor-not-allowed disabled:text-gray-500"
                >
