...
export default function AcceptCustomerInvitationPage() {
    ...
    useEffect(() => {
        const fetchInvitation = async () => {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/customers/invitations/verify/`, {
                    method: 'POST',
                    headers: {
    ...
    const handleAccept = async () => {
        if (!isAuthenticated) {
            router.push(`/login?redirect=/invitations/accept/customer/${token}`);
            return;
        }
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/customers/invitations/accept/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const handleRegister = () => {
        router.push(`/register?email=${encodeURIComponent(invitation.email)}&redirect=/invitations/accept/customer/${token}`);
    };
                ...
                <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
                    <div className="text-center">
                        ...
                        <p className="text-gray-600 mb-2">
                            You've successfully joined <span className="font-semibold text-emerald-600">{invitation.customer.company_name || invitation.customer.name}</span>
                        </p>
                    ...
                    <div className="space-y-4 mb-8">
                        ...
                        <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-lg font-semibold text-gray-900 capitalize">Customer</p>
                            </div>
                        </div>
                    ...
                    {isAuthenticated ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <Button
                                ...
                                size="lg"
                                fullWidth
                                onClick={() => router.push(`/login?redirect=/invitations/accept/customer/${token}`)}
                                className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700"
                            >
                                Log In to Accept
                            </Button>
